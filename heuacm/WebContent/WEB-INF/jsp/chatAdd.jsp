...
<div class="container">
	<div class="row">
        ...
        <h1>发布问题</h1>
        <br>
        <form action="chatAddAction" method="post">
			<span>标题:</span><textarea  class="form-control" id="title" name="title" required="required"></textarea><br>
			<span>内容:</span>
			<textarea name="content" id="content" required="required">在此输入想要输入的内容。</textarea>
			<script>
