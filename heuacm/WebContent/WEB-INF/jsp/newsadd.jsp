...
<div class="container">
	<div class="row">
        ...
        <div class="col-xs-8 ">
        <h2>发布公告</h2><br>
        <form action="newsAddAction" onsubmit="return validate_form();" method="post">
			<span>标题:</span><input type="text" class="form-control" id="title" name="title" required="required"><br>
			<span>内容:</span>
			...
			<span>权限:</span><input type="text" class="form-control" id="auth" name="auth" value="0" required="required" autocomplete="off" onkeyup="check_auth()">
